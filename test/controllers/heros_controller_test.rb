...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { code_sample: @hero.code_sample, color: @hero.color, name: @hero.name, text: @hero.text } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { code_sample: @hero.code_sample, color: @hero.color, name: @hero.name, text: @hero.text } }
